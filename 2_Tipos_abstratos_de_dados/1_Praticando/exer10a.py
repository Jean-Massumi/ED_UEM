class Selecao:
    ...
    def __init__(self, col: int):
        ...
        '''
        if col >= 1 :
          self.coluna_base = col
          self.coluna_inicio = col
          self.coluna_fim = col
    ...
    def move_direita(self):
        ...
        if self.coluna_inicio < self.coluna_base:
          self.coluna_inicio += 1
            
        elif self.coluna_fim >= self.coluna_base:
          self.coluna_fim += 1
    ...
    def move_esquerda(self):
        ...
        if self.coluna_fim > self.coluna_base:
          self.coluna_fim -= 1
          
        elif self.coluna_inicio <= self.coluna_base:
          if self.coluna_inicio > 1:
            self.coluna_inicio -= 1
