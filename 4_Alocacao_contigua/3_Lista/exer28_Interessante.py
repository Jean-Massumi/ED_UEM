...
class Lista:
    ...
    def remove(self, i: int):
        ...
        if (i < self.tamanho // 2):
            ...
            for j in range(i, 0, -1):
                ...
                self.valores[indice_atual] = self.valores[pre_indice]
            ...
            for j in range(i, self.tamanho, 1):
                pos_indice = self._indice_real(j + 1)
                indice_atual = self._indice_real(j)
                
                self.valores[indice_atual] = self.valores[pos_indice]
    ...
    def indice(self, item: int) -> int:
        ...
        for i in range(self.tamanho):
           if (item == self.valores[self._indice_real(i)]):
               return i
    ...
    def str(self) -> str:
        ...
        if (self.num_itens() != 0):
            ...
            for i in range(1, self.tamanho, 1):
                resultado += ', ' + str(self.valores[self._indice_real(i)])
